...
------------------------------------------------------------------
    ...
    <LinearLayout
        android:layout_width="match_parent" <!-- На всю ширину бокса
        хотя можно сделать на половину для удобства пользователя -->
        android:layout_height="wrap_content" <!-- По высоте содержимого -->
        android:orientation="horizontal" <!-- Элементы в одну строку,
        желательно столбиком -->
        ...
        <CheckBox
            ...
            android:buttonTint="#FD7500" <!-- Цвет галочки 
            оранжевый, при изменении темы будет плохо виден -->
            android:layout_marginEnd="12dp" /> <!-- Отступ справа
            от чекбокса до текста что не очень удобно для большинства-->
